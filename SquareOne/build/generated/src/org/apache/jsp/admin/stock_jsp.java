...
public final class stock_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if(session.getAttribute("user_name")==null ||session.getAttribute("user_name").equals(""))
    {
      ...
      out.write("                $.ajax({\r\n");
      out.write("                    type: \"POST\",\r\n");
      out.write("                    url: \"../update_itemquantity\",\r\n");
      out.write("                    data: {sno: sno,qty: avail},\r\n");
      ...
      out.write("            if(e.keyCode===13)\r\n");
      out.write("            {\r\n");
      out.write("                var new_price =document.getElementById('text_price'+sno).value;\r\n");
      out.write("                document.getElementById('text_price'+sno).placeholder = new_price;\r\n");
      out.write("                \r\n");
      out.write("                \r\n");
      out.write("                $.ajax({\r\n");
      out.write("                    type: \"POST\",\r\n");
      out.write("                    url: \"../update_itemprice\",\r\n");
      out.write("                    data: {sno: sno,price: new_price},\r\n");
      out.write("                    success: function (result)\r\n");
      out.write("                    {\r\n");
      out.write("                        \r\n");
      out.write("                        alert(result);\r\n");
      ...
      out.write("        $.ajax({\r\n");
      out.write("            type: \"POST\",\r\n");
      out.write("            url: \"../update_itemstatus\",\r\n");
 ...
 if(item_visibility.equals("0")){ 
      ...
      out.print(sno);
      out.write("\" class=\"visibility_img\"></button>\r\n");
      out.write("                        ");
}
                    else
                    { 
